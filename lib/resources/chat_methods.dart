...
class ChatMethods{
  ...
  void deleteMessage({@required String senderID, @required receiverID, @required String messageId, @required bool forEveryone, @required String currentUserID}) async{
    ...
    if(senderID == currentUserID) {
      ...
      if (forEveryone)
        await _messageCollection
            .doc(receiverID)
            .collection(senderID).doc(messageId).delete();
    } else {
      await _messageCollection
          .doc(receiverID)
          .collection(senderID).doc(messageId).delete();
      ...
      if(forEveryone)
        await _messageCollection
          .doc(senderID)
          .collection(receiverID).doc(messageId).delete();
    }
    // print("sender: $senderID receiver: $receiverID message: $messageId" );
